			...
			array(
				...
				'fields' => array(
					array(
						...
						'desc'     => __( 'To unlock more amazing layout based settings, <a href="' . WOO_GALLERY_SLIDER_PRO_LINK . '" target="_blank"><strong>Upgrade To Pro!</strong></a>', 'woo-gallery-slider' ),
						'options'  => array(
							'horizontal' => array(
							...
							'vertical'   => array(
								...
								'option_name' => __( 'Vertical', 'woo-gallery-slider' ),
								'pro_only'    => true,
							),
							'hide_thumb' => array(
								'image'       => plugin_dir_url( __DIR__ ) . '../img/hide_thumb.png',
								'option_name' => __( 'Hide Thumbnails', 'woo-gallery-slider' ),
								'pro_only'    => true,
							),
						),
						'default'  => 'horizontal',
					...
					array(
						...
						'type'       => 'button_set',
						'title'      => __( 'Thumbnails Position', 'woo-gallery-slider' ),
						'subtitle'   => __( 'Select a position for thumbnails.', 'woo-gallery-slider' ),
						'options'    => array(
							'bottom' => array(
								'option_name' => __( 'Bottom', 'woo-gallery-slider' ),
							),
							'top'    => array(
								'option_name' => __( 'Top', 'woo-gallery-slider' ),
								'pro_only'    => true,
							),
						),
						'default'    => 'bottom',
					...
					array(
						'id'       => 'include_feature_image',
						'type'     => 'checkbox',
						'title'    => esc_html__( 'Include Feature Image', 'woo-gallery-slider' ),
						'subtitle' => esc_html__( 'If check, Product Image (Feature Image) will show as the first image in the Gallery. If unchecked and Product Image is not used in the Gallery unless it is uploaded to the Product Gallery.', 'woo-gallery-slider' ),
						'default'  => true,
					),
